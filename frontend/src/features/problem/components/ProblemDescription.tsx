      ...
      <div className="flex items-center justify-between border-b border-white/5 px-2 pt-2 shrink-0">
        <div className="flex items-center overflow-x-auto no-scrollbar">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium transition-colors whitespace-nowrap ${activeTab === 'description' ? 'text-primary border-b-2 border-primary' : 'text-muted-foreground hover:text-foreground'}`}
          >
            Description
          </button>
          <button
            onClick={() => setActiveTab('submissions')}
            className={`px-4 py-2 text-sm font-medium transition-colors whitespace-nowrap ${activeTab === 'submissions' ? 'text-primary border-b-2 border-primary' : 'text-muted-foreground hover:text-foreground'}`}
          >
            Submissions
          </button>
          <button
            onClick={() => setActiveTab('solutions')}
            className={`px-4 py-2 text-sm font-medium transition-colors whitespace-nowrap ${activeTab === 'solutions' ? 'text-primary border-b-2 border-primary' : 'text-muted-foreground hover:text-foreground'}`}
          >
            Solutions
          </button>
          {isAIEnabled && (
            <button
              ...
              className={`px-4 py-2 text-sm font-medium transition-colors whitespace-nowrap ${activeTab === 'ai_analysis' ? 'text-primary border-b-2 border-primary' : 'text-muted-foreground hover:text-foreground'}`}
            >
              AI Analysis
            </button>
          )}
